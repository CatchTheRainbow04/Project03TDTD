...
<body>
	...
	<div class="container mt-4">
		...
		%>
			<a href="#" onclick="loadContent('departmentForm.jsp?action=add')"
				class="btn btn-add"> <i class="fas fa-plus"></i> Thêm phòng ban
			</a>
			<%
		}
		%>
		...
		%>
						<td><a href="#"
							onclick="loadContent('departmentForm.jsp?action=update&id=<%= dept.getDepartmentId() %>')"
							class="btn btn-sm btn-edit">Sửa</a></td>
						<td><a
							href="DepartmentServlet?action=delete&id=<%= dept.getDepartmentId() %>"
		...
		%>
                    ...
                    %>
					<tr>
						<td colspan="4" class="text-center">Không có dữ liệu phòng
							ban.</td>
					</tr>
					<%
                        }
