<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, model.Attendance, model.Employee, java.text.SimpleDateFormat"%>
<%
...
<div class="container mt-4">
	<div class="d-flex justify-content-between align-items-center mb-4">
		...
		%>
		<a href="#" onclick="loadContent('attendanceForm.jsp?action=add')"
			class="btn btn-add"> <i class="fas fa-plus"></i> Thêm chấm công
		</a>
		<%
		}
		%>
		...
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><span
						class="status <%=att.getStatus() != null && att.getStatus().equals("Đi làm") ? "green"
		: (att.getStatus() != null && att.getStatus().equals("Vắng mặt") ? "red" : "orange")%>">
					...
					%>
					<td><a href="#"
						onclick="loadContent('attendanceForm.jsp?action=update&id=<%=att.getAttendanceId()%>')"
				...
				%>
				<tr>
					<td colspan="7" class="text-center">Không có dữ liệu chấm
						công.</td>
				</tr>
				<%
				}
