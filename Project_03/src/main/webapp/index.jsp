...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/index_style.css?v=<%= System.currentTimeMillis() %>">
<link rel="stylesheet"
...
<body>
		...
		<ul>
			...
			<li class="active"><a href="#"
				onclick="loadContent('AttendanceServlet')"> <svg
						...
						<path
							d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" /></svg>
					<span>Danh sách chấm công</span>
			</a></li>
			<li><a href="#" onclick="loadContent('DepartmentServlet')">
			...
			<li><a href="#" onclick="loadContent('EmployeeServlet')"> <svg
			...
			<li><a href="#" onclick="loadContent('GreenProjectServlet')">
			...
			<li><a href="#" onclick="loadContent('PositionServlet')"> <svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
						height="24px" width="24px" fill="#e8eaed">
						<path
			...
			<li><a href="#"
				onclick="loadContent('ProjectAssignmentServlet')"> <svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
						height="24px" width="24px" fill="#e8eaed">
						<path
					...
					<span>Danh sách phân công dự án</span>
			</a></li>
			<li><a href="#" onclick="loadContent('SalaryServlet')"> <svg
			...
			<li><a href="#" onclick="loadContent('UserServlet')"> <svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
						height="24px" width="24px" fill="#e8eaed">
						<path
	...
	<div class="right-area">
		...
		<main class="content">
			<div id="content-area">
				<h3>Chào mừng đến với hệ thống quản lý nhân sự!</h3>
				<p>Vui lòng chọn một mục từ thanh điều hướng để xem thông tin.</p>
			</div>
		</main>
	</div>
</body>
