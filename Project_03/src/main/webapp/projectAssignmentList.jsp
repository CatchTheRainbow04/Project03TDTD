<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, model.ProjectAssignment, model.GreenProject, model.Employee , java.text.SimpleDateFormat"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
String role = (String) session.getAttribute("role");
	...
	<div class="container mt-4">
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			%>
			<a href="#"
				onclick="loadContent('projectAssignmentForm.jsp?action=add')"
				class="btn btn-add"> <i class="fas fa-plus"></i> Thêm phân công
			</a>
			<%
			}
			%>
		...
		<div class="table-responsive">
			...
			%>
						<td><a href="#"
							onclick="loadContent('projectAssignmentForm.jsp?action=update&id=<%= assign.getAssignmentId() %>')"
							class="btn btn-sm btn-edit">Sửa</a> <a
							href="ProjectAssignmentServlet?action=delete&id=<%= assign.getAssignmentId() %>"
			...
			%>
                    ...
                    %>
					<tr>
						<td colspan="7" class="text-center">Không có dữ liệu phân
							công dự án.</td>
					</tr>
					<%
                        }
