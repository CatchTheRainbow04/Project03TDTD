...
String role = (String) session.getAttribute("role");
	...
	<div class="container mt-4">
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			%>
			<a href="#" onclick="loadContent('salaryForm.jsp?action=add')"
				class="btn btn-add"> <i class="fas fa-plus"></i> Thêm lương
			</a>
			<%
			}
			%>
		...
		<div class="table-responsive">
			...
			%>
				...
				<tbody>
					...
					<tr>
						...
						<td><span
							class="status <%= sal.getPaymentStatus() != null && sal.getPaymentStatus().equals("Đã thanh toán") ? "green" : "red" %>">
			...
			%>
						<td><a href="#"
							onclick="loadContent('salaryForm.jsp?action=update&id=<%= sal.getSalaryId() %>')"
							class="btn btn-sm btn-edit">Sửa</a> <a
							href="SalaryServlet?action=delete&id=<%= sal.getSalaryId() %>"
