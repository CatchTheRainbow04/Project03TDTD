...
String role = (String) session.getAttribute("role");
	...
	<div class="container mt-4">
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			%>
			<a href="#" onclick="loadContent('positionForm.jsp?action=add')"
				class="btn btn-add"> <i class="fas fa-plus"></i> Thêm chức vụ
			</a>
			<%
			}
			%>
			...
			%>
				...
				<tbody>
					...
					<tr>
						...
						<td><%= pos.getSalaryBase() != null ? pos.getSalaryBase() : "0" %>
							VND</td>
						<%
			if ("Admin".equals(role)) {
			%>
						<td><a href="#"
							onclick="loadContent('positionForm.jsp?action=update&id=<%= pos.getPositionId() %>')"
							class="btn btn-sm btn-edit">Sửa</a> <a
							href="PositionServlet?action=delete&id=<%= pos.getPositionId() %>"
